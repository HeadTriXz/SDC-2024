...
class PedestrianHandler(BaseObjectHandler):
    ...
    @staticmethod
    def __get_direction(history: np.ndarray) -> int:
    ...
    @staticmethod
    def __get_most_recent_side(history: np.ndarray) -> int:
    ...
    @staticmethod
    def __get_relative_position(crosswalk: np.ndarray, pedestrian: np.ndarray) -> np.ndarray:
    ...
    @staticmethod
    def __overlaps(pedestrian: np.ndarray) -> bool:
        ...
        return min_margin <= pedestrian[3] <= max_margin and (
            min_margin <= pedestrian[0] <= max_margin or min_margin <= pedestrian[2] <= max_margin
        )

    @staticmethod
    def __xyxy_to_centroid(xyxy: np.ndarray) -> np.ndarray:
